...
interface SourceSetCreator {
    ...
    fun create(namedDomainObjectContainer: NamedDomainObjectContainer<AndroidSourceSet>)
}

object Main: SourceSetCreator {
    override val name: String = InternalSourceSets.MAIN

    override fun create(namedDomainObjectContainer: NamedDomainObjectContainer<AndroidSourceSet>) {
